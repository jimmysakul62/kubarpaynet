...
export function renderInfoKontak() {
    ...
    container.innerHTML = `
        <div style="display: flex; justify-content: center; padding-top: 50px; height: 100%; box-sizing: border-box;">
            ...
            <div style="background-color: #C3D69B; padding: 30px 40px; border: 1px solid #000; width: 450px; font-family: Arial, sans-serif; box-shadow: 4px 4px 0px rgba(0,0,0,0.1);">
                
                <h2 style="text-align: center; color: #FFC000; font-size: 26px; font-weight: bold; margin-top: 0; margin-bottom: 30px; letter-spacing: 1px;">
                    INFO KONTAK ADMIN
                </h2>
